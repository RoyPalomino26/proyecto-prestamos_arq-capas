...
import static dev.pitt.loans.loan_project.controller.constants.ApiEndPointsConstant.API_CLIENT_PHONE;

@RequestMapping(API_CLIENT_PHONE)
public interface ClientPhoneController {

    @PostMapping
    ResponseEntity<CustomResponse> save(
            @Valid @RequestBody ClientPhoneRequestDTO clientPhoneRequestDTO,
