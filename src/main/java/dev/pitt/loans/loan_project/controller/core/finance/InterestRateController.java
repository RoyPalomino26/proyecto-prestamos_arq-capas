...
import static dev.pitt.loans.loan_project.controller.constants.ApiEndPointsConstant.API_INTEREST_RATE;

@RequestMapping(API_INTEREST_RATE)
public interface InterestRateController {

    @PostMapping
    ResponseEntity<CustomResponse> save(
            @Valid @RequestBody InterestRateRequestDTO interestRateRequestDTO,
